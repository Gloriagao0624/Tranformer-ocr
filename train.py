...
def train():
    batch_size = 64
    train_dataloader = torch.utils.data.DataLoader(ListDataset(['./CUTE80-master/gt.txt']), batch_size=batch_size, shuffle=True, num_workers=0)
    ...
    model.load_state_dict(torch.load('resnet101.pth'),False)
    #model.cuda()
